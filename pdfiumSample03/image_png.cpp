...
namespace image { namespace png { namespace {
    ...
    std::vector<uint8_t> Encode(
        ...
        return EncodeWithCompressionLevel(input, format, width, height,
            ...
            comments, PNG_Z_DEFAULT_COMPRESSION);
    }
